...
export function LeaderboardCard({ data, isLoading, monthName, year }: LeaderboardCardProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>🌽 Leaderboard KSA Jagung</CardTitle>
        <CardDescription>Peringkat 3 kabupaten tercepat yang menyelesaikan 100% amatan jagung pada bulan {monthName} {year}.</CardDescription>
      </CardHeader>
      <CardContent>
        {data && data.length > 0 ? (
