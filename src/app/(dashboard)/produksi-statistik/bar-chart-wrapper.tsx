...
export default function BarChartWrapper({ data, dataKey1, dataKey2, onClick, isMobile }: BarChartWrapperProps) {
  
  // PATCH: Logika kondisional untuk mengubah layout grafik
  if (isMobile) {
    // TAMPILAN MOBILE: GRAFIK VERTIKAL
    return (
  ...
  // TAMPILAN DESKTOP: GRAFIK HORIZONTAL (SEPERTI SEBELUMNYA)
  return (
